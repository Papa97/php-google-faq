...
$faqs = [
    [
        'titolo' => "<div><h2>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h2>",
        'contenuto' => "
        <p>
    ...
    [
        'titolo' => '<div><h2>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?
        </h2>',
        'contenuto' => "
        <p>
    ...
    [
        'titolo' => "<div><h3>Perché il mio account è associato a un paese?</h3>",
        'contenuto' => "
        <p>
